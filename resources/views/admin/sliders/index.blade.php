                    ...
                    <tbody>
                        @foreach ($sliders as $index => $slider)
                            <tr>
                                <td>{{ $index + 1 }}</td>
                                <td>
                                    <img src="{{ asset('slider-images/' . $slider->image) }}" alt="Slider Image" style="max-width: 50px; max-height: 50px;">
                                </td>
                                <td>{{ $slider->name }}</td>
                                <td>{{ Str::limit($slider->description, 50) }}</td>
                                <td>
                                    <a href="{{ route('admin.sliders.edit', $slider->id) }}" class="btn btn-info btn-sm">Edit</a>
