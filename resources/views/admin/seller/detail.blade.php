                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-unstyled mb-4">
                            ...
                            <li class="hstack justify-content-between mb-4">
                                ...
                                <span class="float-end">{{ $soldProductsCount }}</span>
                            </li>
                        ...
                        <div class="tab-pane fade show active p-4" id="overviewTab" role="tabpanel">
                            <div class="profile-details mb-5">
                                ...
                                <div class="row g-0 mb-4">
                                    ...
                                    <div class="col-sm-6 fw-semibold">{{ $seller->name }}</div>
                                </div>
                                <div class="row g-0 mb-4">
                                    <div class="col-sm-6 text-muted">Email Address:</div>
                                    <div class="col-sm-6 fw-semibold">{{ $seller->email }}</div>
                                </div>
                                <div class="row g-0 mb-4">
                                    <div class="col-sm-6 text-muted">Address:</div>
                                    <div class="col-sm-6 fw-semibold">{{ $sellerProfile->alamat ?? 'N/A' }}</div>
                                </div>
                                <div class="row g-0 mb-4">
                                    <div class="col-sm-6 text-muted">IP Seller:</div>
                                    <div class="col-sm-6 fw-semibold">{{ $sellerProfile->last_login_ip ?? 'N/A' }}</div>
                                </div>
                                <div class="row g-0 mb-4">
                                    <div class="col-sm-6 text-muted">Device:</div>
                                    <div class="col-sm-6 fw-semibold">{{ $sellerProfile->device_info ?? 'N/A' }}</div>
                                </div>
                                <div class="row g-0 mb-4">
                                    <div class="col-sm-6 text-muted">Location:</div>
                                    <div class="col-sm-6 fw-semibold">@if($sellerProfile->latitude && $sellerProfile->longitude)
                                        <p><strong>Location (Latitude, Longitude):</strong>
                                            {{ $sellerProfile->latitude }}, {{ $sellerProfile->longitude }}
                                        </p>
                                        <p><strong>Google Maps Link:</strong>
                                            <a href="https://www.google.com/maps/search/?api=1&query={{ $sellerProfile->latitude }},{{ $sellerProfile->longitude }}" target="_blank">
                                                View on Google Maps
                                            </a>
                                        </p>
                                    @else
