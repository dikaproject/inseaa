                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.testimonials.update', $testimonial->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input value="{{ $testimonial->name }}" type="text" name="name" id="name" class="form-control">
                            </div>
                            <div class="mb-3">
                                <label for="message" class="form-label">Description</label>
                                <textarea name="message" id="message" class="form-control">{{ $testimonial->message }}</textarea>
                            </div>
                            <div class="mb-3">
                                <label for="link_post" class="form-label">Link Postingan</label>
                                <input value="{{ $testimonial->link_post }}" type="text" name="link_post" id="link_post" class="form-control">
                            </div>
                            <div class="mb-3">
