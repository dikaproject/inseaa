...
<head>
    ...
    <title>Register Seller / UMKM || INSEAA</title>
            ...
            <div class="minimal-card-wrapper">
                <div class="card mb-4 mt-5 mx-4 mx-sm-0 position-relative">
                    <div
                        ...
                        <img src="{{ asset('assets/img/logoinseaa.png') }}" alt="" class="img-fluid">
                    </div>
                    <div class="card-body p-sm-5">
                        <h2 class="fs-20 fw-bolder mb-4">Register</h2>
                        <h4 class="fs-13 fw-bold mb-2">Login to your account UMKM</h4>
                        ...
                        <form action="{{ route('seller.register') }}" method="POST" class="w-100 mt-4 pt-2">
                            @csrf
                            <div class="mb-4">
                                <input placeholder="Masukan Nama Anda" id="name" type="text" name="name"
                            ...
                            <div class="mb-4">
                                <input placeholder="Masukan Email Anda" id="email" type="email" name="email"
                            ...
                            <div class="mb-4">
                                <input placeholder="Masukan Nomer Whatsapp Aktif" id="no_telepon" type="text"
                            ...
                            <div class="mb-4">
                                <input placeholder="Masukan Alamat Lengkap Anda" id="alamat" type="text"
                            ...
                            <div class="mb-3">
                                <input placeholder="Masukan Password" id="password" type="password" name="password"
                                    required>
                                @error('password')
                                    <div>{{ $message }}</div>
                                @enderror
                            ...
                            <div class="mb-3">
                                <input placeholder="Masukan Ulang Password" id="password_confirmation" type="password"
