        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-6 col-12">
                    <h5 class="title">Inseaa Seller Register</h5>
                </div>
                <div class="col-lg-6 col-md-6 col-12">
                    <ul class="breadcrumb-list">
                        <li><a href="index.html">Home</a></li>
                        <li><i class="feather-chevron-right"></i></li>
                        <li class="current">Inseaa Seller Resgister</li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <div class="form-wrapper-one">
                        ...
                        <form action="{{ route('seller.register') }}" method="POST">
                            ...
                            <div class="mb-5">
                                ...
                                <input type="text" id="name" name="name" class="form-label" placeholder="Masukkan Nama Anda" required autofocus value="{{ old('name') }}">
                                @error('name')
                                    <div>{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="mb-5">
                                ...
                                <input type="email" id="email" name="email" class="form-label" placeholder="Masukkan Email Anda" required value="{{ old('email') }}">
                                @error('email')
                                    <div>{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="mb-5">
                                ...
                                <input type="text" id="no_telepon" name="no_telepon" class="form-label" placeholder="Masukkan Nomor WhatsApp" required value="{{ old('no_telepon') }}">
                                @error('no_telepon')
                                    <div>{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="mb-5">
                                ...
                                <input type="text" id="alamat" name="alamat" class="form-label" placeholder="Masukkan Alamat Lengkap" required value="{{ old('alamat') }}">
                                @error('alamat')
                                    <div>{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-5">
                                ...
                                <input type="password" id="password_confirmation" name="password_confirmation" class="form-label" placeholder="Masukkan Ulang Password" required>
                            </div>
